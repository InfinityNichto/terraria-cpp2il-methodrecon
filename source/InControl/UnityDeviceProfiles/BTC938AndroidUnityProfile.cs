...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x06000597 RID: 1431 RVA: 0x000126A0 File Offset: 0x000108A0
		public override void Define()
		{
			base.Define();
			this.deviceName = "BTC-938";
			this.deviceClass = InputDeviceClass.Controller;
			this.deviceNotes = "BTC-938 on Android";
			if ("BTC-938 on Android" == null || "BTC-938 on Android" != null)
			{
				if ("A" == null)
				{
				}
		...
		// Token: 0x06000598 RID: 1432 RVA: 0x00012820 File Offset: 0x00010A20
