...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x06000615 RID: 1557 RVA: 0x00018610 File Offset: 0x00016810
		public override void Define()
		{
			base.Define();
			this.deviceName = "PlayStation 4 Controller";
			this.deviceNotes = "PlayStation 4 Controller on Linux";
		...
		// Token: 0x06000616 RID: 1558 RVA: 0x0001878C File Offset: 0x0001698C
