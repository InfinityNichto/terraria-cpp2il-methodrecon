...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x060006B3 RID: 1715 RVA: 0x0001F88C File Offset: 0x0001DA8C
		public override void Define()
		{
			...
			if ("Windows" == null || "Windows" != null)
			{
				...
				InputControlSource inputControlSource9 = InputDeviceProfile.Button(0);
				InputControlSource inputControlSource10 = InputDeviceProfile.Button(1);
				InputControlSource inputControlSource11 = InputDeviceProfile.Button(2);
				InputControlSource inputControlSource12 = InputDeviceProfile.Button(3);
				...
				InputControlSource inputControlSource15 = InputDeviceProfile.Button(5);
				InputControlSource inputControlSource16 = InputDeviceProfile.Button(4);
				InputControlSource inputControlSource17 = InputDeviceProfile.Button(6);
		...
		// Token: 0x060006B4 RID: 1716 RVA: 0x0001F9E8 File Offset: 0x0001DBE8
