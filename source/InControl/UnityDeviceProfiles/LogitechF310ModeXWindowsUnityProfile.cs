...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x06000695 RID: 1685 RVA: 0x0001E094 File Offset: 0x0001C294
		public override void Define()
		{
			base.Define();
			this.deviceName = "Logitech F310 Controller";
			this.deviceNotes = "Logitech F310 Controller on Windows (XInput Mode)";
		...
		// Token: 0x06000696 RID: 1686 RVA: 0x0001E20C File Offset: 0x0001C40C
