...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x0600059B RID: 1435 RVA: 0x000129D0 File Offset: 0x00010BD0
		public override void Define()
		{
			base.Define();
			this.deviceName = "DroidBOX GPD XD PlayON - Xbox Mode";
			this.deviceClass = InputDeviceClass.Controller;
			this.deviceNotes = "DroidBOX GPD XD PlayON - Xbox Mode on Android";
							...
							if (inputControlMapping4 == null || inputControlMapping4 != null)
							{
								...
								if (inputControlMapping5 == null || inputControlMapping5 != null)
								{
									...
									if (inputControlMapping6 == null || inputControlMapping6 != null)
									{
										...
										if ((inputControlMapping7 == null || inputControlMapping7 != null) && (InputDeviceProfile.RightStickDownMapping(3) == null || inputControlMapping7 != null))
										{
											...
											if (inputControlMapping8 == null || inputControlMapping8 != null)
											{
												...
												{
													InputControlMapping inputControlMapping10 = InputDeviceProfile.DPadUpMapping(5);
													if (inputControlMapping10 == null || inputControlMapping10 != null)
													{
														InputControlMapping inputControlMapping11 = InputDeviceProfile.DPadDownMapping(5);
		...
		// Token: 0x0600059C RID: 1436 RVA: 0x00012B4C File Offset: 0x00010D4C
