...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x0600065B RID: 1627 RVA: 0x0001B904 File Offset: 0x00019B04
		public override void Define()
		{
			base.Define();
			this.deviceName = "Razer Serval Controller";
			this.deviceClass = InputDeviceClass.Controller;
			this.deviceNotes = "Razer Serval Controller on Razer Forge TV";
			if ("Razer Forge" == null || "Razer Forge" != null)
			{
				if ("A" == null)
				{
				}
												...
												if (inputControlMapping9 == null || inputControlMapping9 != null)
												{
													...
													if (inputControlMapping10 == null || inputControlMapping10 != null)
													{
														...
														if (inputControlMapping11 == null || inputControlMapping11 != null)
														{
															...
															{
																InputControlSource inputControlSource12 = InputDeviceProfile.Analog(6);
																InputControlSource inputControlSource13 = InputDeviceProfile.Analog(7);
																InputControlSource inputControlSource14 = InputDeviceProfile.Analog(12);
																InputControlSource inputControlSource15 = InputDeviceProfile.Analog(11);
																return;
															}
														}
													}
		...
		// Token: 0x0600065C RID: 1628 RVA: 0x0001BAA4 File Offset: 0x00019CA4
