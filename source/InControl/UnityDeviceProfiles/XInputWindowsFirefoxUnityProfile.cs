...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x06000679 RID: 1657 RVA: 0x0001CC80 File Offset: 0x0001AE80
		public override void Define()
		{
			base.Define();
			this.deviceName = "XInput Controller";
			this.deviceNotes = "XInput Controller on Windows Firefox";
		...
		// Token: 0x0600067A RID: 1658 RVA: 0x0001CDAC File Offset: 0x0001AFAC
