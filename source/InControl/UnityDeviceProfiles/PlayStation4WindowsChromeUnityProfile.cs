...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x06000673 RID: 1651 RVA: 0x0001C8B4 File Offset: 0x0001AAB4
		public override void Define()
		{
			base.Define();
			this.deviceName = "PlayStation 4 Controller";
			this.deviceNotes = "PlayStation 4 Controller on Windows Chrome";
		...
		// Token: 0x06000674 RID: 1652 RVA: 0x0001C9E0 File Offset: 0x0001ABE0
