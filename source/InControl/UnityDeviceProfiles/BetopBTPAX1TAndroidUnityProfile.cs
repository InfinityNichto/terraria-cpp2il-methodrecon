...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x06000593 RID: 1427 RVA: 0x00012370 File Offset: 0x00010570
		public override void Define()
		{
			base.Define();
			this.deviceName = "BETOP BTP-AX1T Controller";
			this.deviceNotes = "BETOP BTP-AX1T Controller on Android";
			if ("Android" != null)
			{
			}
			if ("A" == null)
			...
			InputControlSource inputControlSource9 = InputDeviceProfile.Button(int.MinValue);
		...
		// Token: 0x06000594 RID: 1428 RVA: 0x000124F4 File Offset: 0x000106F4
