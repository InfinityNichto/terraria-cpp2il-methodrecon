...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x0600065D RID: 1629 RVA: 0x0001BABC File Offset: 0x00019CBC
		public override void Define()
		{
			base.Define();
			this.deviceName = "Xbox One Controller";
			this.deviceNotes = "Xbox One Controller on Xbox One";
			if (("XBOXONE" == null || "XBOXONE" != null) && ("DURANGOOS" == null || "DURANGOOS" != null))
			{
				if ("A" == null)
				{
				}
		...
		// Token: 0x0600065E RID: 1630 RVA: 0x0001BC58 File Offset: 0x00019E58
