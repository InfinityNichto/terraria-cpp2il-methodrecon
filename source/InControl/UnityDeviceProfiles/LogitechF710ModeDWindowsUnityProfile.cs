...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x0600069B RID: 1691 RVA: 0x0001E544 File Offset: 0x0001C744
		public override void Define()
		{
			base.Define();
			this.deviceName = "Logitech F710 Controller";
			this.deviceNotes = "Logitech F710 on Windows (DirectInput Mode)";
		...
		// Token: 0x0600069C RID: 1692 RVA: 0x0001E6BC File Offset: 0x0001C8BC
