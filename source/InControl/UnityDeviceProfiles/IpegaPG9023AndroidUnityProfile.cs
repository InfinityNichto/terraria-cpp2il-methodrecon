...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x060005C1 RID: 1473 RVA: 0x00014658 File Offset: 0x00012858
		public override void Define()
		{
			base.Define();
			this.deviceName = "IPEGA PG-9023";
			this.deviceClass = InputDeviceClass.Controller;
			this.deviceNotes = "IPEGA PG-9023 on Android";
		...
		// Token: 0x060005C2 RID: 1474 RVA: 0x000147C8 File Offset: 0x000129C8
