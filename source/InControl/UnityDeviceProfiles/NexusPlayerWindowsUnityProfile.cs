...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x060006A7 RID: 1703 RVA: 0x0001EED8 File Offset: 0x0001D0D8
		public override void Define()
		{
			base.Define();
			this.deviceName = "Nexus Player Controller";
			this.deviceClass = InputDeviceClass.Controller;
			this.deviceNotes = "Nexus Player Controller on Windows";
			if ("Windows" == null || "Windows" != null)
			{
				...
				InputControlSource inputControlSource2 = InputDeviceProfile.Button(9);
				...
				InputControlSource inputControlSource9 = InputDeviceProfile.Button(1);
		...
		// Token: 0x060006A8 RID: 1704 RVA: 0x0001F050 File Offset: 0x0001D250
