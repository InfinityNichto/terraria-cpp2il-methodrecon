...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x0600060D RID: 1549 RVA: 0x00017FFC File Offset: 0x000161FC
		public override void Define()
		{
			base.Define();
			this.deviceName = "Moga Pro";
			this.deviceClass = InputDeviceClass.Controller;
			this.deviceNotes = "Moga Pro on Linux";
												...
												if (inputControlMapping9 == null || inputControlMapping9 != null)
												{
													...
													if (inputControlMapping10 == null || inputControlMapping10 != null)
													{
														...
														if (inputControlMapping11 == null || inputControlMapping11 != null)
														{
															...
															{
																InputControlSource inputControlSource10 = InputDeviceProfile.Analog(5);
																InputControlSource inputControlSource11 = InputDeviceProfile.Analog(4);
																return;
															}
														}
													}
		...
		// Token: 0x0600060E RID: 1550 RVA: 0x00018178 File Offset: 0x00016378
