...
namespace InControl.UnityDeviceProfiles
{
	...
	{
		// Token: 0x0600063B RID: 1595 RVA: 0x0001A1F0 File Offset: 0x000183F0
										...
										if (inputControlMapping7 == null || inputControlMapping7 != null)
										{
											...
											if (inputControlMapping8 == null || inputControlMapping8 != null)
											{
												...
												if (inputControlMapping9 == null || inputControlMapping9 != null)
												{
													...
													{
														InputControlMapping inputControlMapping11 = InputDeviceProfile.DPadLeftMapping(6);
														if (inputControlMapping11 == null || inputControlMapping11 != null)
														{
															InputControlMapping inputControlMapping12 = InputDeviceProfile.DPadRightMapping(6);
															if (inputControlMapping12 == null || inputControlMapping12 != null)
															{
																InputControlMapping inputControlMapping13 = InputDeviceProfile.DPadUpMapping(7);
																if (inputControlMapping13 == null || inputControlMapping13 != null)
																{
																	InputControlMapping inputControlMapping14 = InputDeviceProfile.DPadDownMapping(7);
		...
		// Token: 0x0600063C RID: 1596 RVA: 0x0001A390 File Offset: 0x00018590
