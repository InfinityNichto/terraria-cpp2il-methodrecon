...
ICSharpCode.Decompiler.DecompilerException: Error decompiling UnityEngine.SocialPlatforms.ILocalUser UnityEngine.Social::get_localUser()

 ---> System.Exception: Basic block has to end with unconditional control flow. 
{
	Block_0:
	stloc:ISocialPlatform(var_0_05, callgetter:ISocialPlatform(ActivePlatform::get_Instance))
}
